...
const (
	TaskService_CreateTask_FullMethodName        = "/apex.TaskService/CreateTask"
	TaskService_GetTask_FullMethodName           = "/apex.TaskService/GetTask"
	TaskService_ListTasks_FullMethodName         = "/apex.TaskService/ListTasks"
	TaskService_CancelTask_FullMethodName        = "/apex.TaskService/CancelTask"
	TaskService_StreamTaskResults_FullMethodName = "/apex.TaskService/StreamTaskResults"
)
...
func (c *taskServiceClient) StreamTaskResults(ctx context.Context, in *StreamTaskResultsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[TaskResult], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &TaskService_ServiceDesc.Streams[0], TaskService_StreamTaskResults_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type TaskService_StreamTaskResultsClient = grpc.ServerStreamingClient[TaskResult]
...
func (UnimplementedTaskServiceServer) StreamTaskResults(*StreamTaskResultsRequest, grpc.ServerStreamingServer[TaskResult]) error {
	return status.Error(codes.Unimplemented, "method StreamTaskResults not implemented")
}
...
func _TaskService_StreamTaskResults_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(StreamTaskResultsRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(TaskServiceServer).StreamTaskResults(m, &grpc.GenericServerStream[StreamTaskResultsRequest, TaskResult]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type TaskService_StreamTaskResultsServer = grpc.ServerStreamingServer[TaskResult]

// TaskService_ServiceDesc is the grpc.ServiceDesc for TaskService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var TaskService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "apex.TaskService",
	...
	Streams: []grpc.StreamDesc{
		{
			...
			Handler:       _TaskService_StreamTaskResults_Handler,
			ServerStreams: true,
		},
	},
